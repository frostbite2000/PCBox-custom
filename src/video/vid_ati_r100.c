...
r100_pci_read(int func, int addr, void *p)
{
    ...
    case 0x03: return 0x51;
    
    case 0x04: return (r100->pci_regs[0x04] & 0x17) | 0x80; /*Respond to IO and memory accesses*/
    case 0x05: return r100->pci_regs[0x05] & 0x03;
    ...
    case 0x13: return r100->lfb_base >> 24;

    case 0x14: return 0x01;
    case 0x15: return r100->io_base >> 8;
    case 0x16: return r100->io_base >> 16;
    case 0x17: return r100->io_base >> 24;

    case 0x1b: return r100->mmio_base >> 24;

    case 0x2c: case 0x2d: case 0x2e: case 0x2f:
        return r100->pci_regs[addr];

    case 0x30: return (r100->pci_regs[0x30] & 0x01); /*BIOS ROM address*/
    case 0x31: return 0x00;
    case 0x32: return r100->pci_regs[0x32];
    case 0x33: return r100->pci_regs[0x33];

    case 0x34: return 0x50;

    case 0x3c: return r100->int_line;
    case 0x3d: return PCI_INTA;

    case 0x3e: return 0x03;
    case 0x3f: return 0x01;

    case 0x50: return 0x01;
    case 0x52: return 0x02;
    case 0x53: return 0x06;
    
    case 0x58: return 0x02;
    case 0x59: return 0x50;
    case 0x5a: return 0x20;

    case 0x5c: return 0x07;
    case 0x5d: return 0x02;
    case 0x5f: return 0x2f;

    case 0x61: return 0x02;
    }
...
r100_pci_write(int func, int addr, uint8_t val, void *p)
{
    ...
    case PCI_REG_COMMAND:
        ...
        if (val & PCI_COMMAND_IO)
        {
            ...
            if(r100->io_base) io_sethandler(r100->io_base, 0x0100, r100_in, NULL, NULL, r100_out, NULL, NULL, r100);
        }
    ...
    case 0x15:
        ...
        if(r100->io_base) io_sethandler(r100->io_base & 0xff00, 0x0100, r100_in, NULL, NULL, r100_out, NULL, NULL, r100);
        break;
...
r100_mmio_read_l(uint32_t addr, void *p)
{
    ...
    if((addr >= 0xf00) && (addr <= 0xfff)) return r100_pci_read(0, addr&0xff, r100)|(r100_pci_read(0, (addr+1)&0xff, r100)<<8)
...
r100_mmio_read(uint32_t addr, void *p)
{
    ...
    if((addr >= 0xf00) && (addr <= 0xfff)) return r100_pci_read(0, addr & 0xff, r100);
...
r100_out(uint16_t addr, uint8_t val, void *p)
{
    ...
    if((addr >= r100->io_base) && (addr < (r100->io_base + 0x100)))
    {
...
*r100_init(const device_t *info)
{
    ...
    r100->card = pci_add_card(PCI_ADD_AGP, r100_pci_read, r100_pci_write, r100);
