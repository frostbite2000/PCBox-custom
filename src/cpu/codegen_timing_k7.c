...
static const macro_op_t alup01_op = {
    .nr_uops     = 1,
    .decode_type = DECODE_SIMPLE,
...
static int
uop_run(const k7_uop_t *uop, int decode_time)
{
...
void
codegen_timing_k7_block_start(void)
{
    int c;
...
void
codegen_timing_k7_prefix(uint8_t prefix, uint32_t fetchdat)
{
    if (prefix != 0x0f)
        decode_timestamp++;
...
void
codegen_timing_k7_opcode(uint8_t opcode, uint32_t fetchdat, int op_32, uint32_t op_pc)
{
...
void
codegen_timing_k7_block_end(void)
{
    if (decode_buffer.nr_uops) {
        int old_last_complete_timestamp = last_complete_timestamp;
        decode_flush_k7();
...
int
codegen_timing_k7_jump_cycles(void)
{
    if (decode_buffer.nr_uops)
        return 1;
    return 0;
...
codegen_timing_t codegen_timing_k7 = {
    codegen_timing_k7_start,
    codegen_timing_k7_prefix,
    codegen_timing_k7_opcode,
    codegen_timing_k7_block_start,
    codegen_timing_k7_block_end,
    codegen_timing_k7_jump_cycles
};